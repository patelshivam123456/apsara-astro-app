...
export const styles = StyleSheet.create({
  ...
  gridIntro: { minHeight: 58, borderRadius: 8, backgroundColor: "#f8fff6", paddingHorizontal: spacing.sm, paddingVertical: spacing.sm, flexDirection: "column", gap: spacing.sm, shadowColor: "#0d5a1d", shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.18, shadowRadius: 5, elevation: 4 },
  gridIntroTitleWrap: { minWidth: 118, minHeight: 38, borderRadius: 6, backgroundColor: "#bff2c6", alignItems: "center", justifyContent: "center", paddingHorizontal: spacing.sm },
  gridIntroTitle: { color: "#145c24", fontFamily: "serif", fontSize: 15, lineHeight: 20, fontWeight: "900", textAlign: "center" },
  gridIntroDescription: { flex: 1, color: "#243727", fontSize: 12, lineHeight: 17, fontWeight: "700" },
