...
export const styles = StyleSheet.create({
  ...
  gridIntro: {   paddingHorizontal: spacing.sm,  flexDirection: "column", gap: spacing.md, shadowColor: "#0d5a1d", shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.18, shadowRadius: 5, elevation: 4 },
  gridIntroTitleWrap: {  width: "100%", borderRadius: 6, backgroundColor: "#bff2c6", alignItems: "flex-start", justifyContent: "center", paddingHorizontal: spacing.md, paddingVertical: 6 },
  gridIntroTitle: { width: "100%", color: "#145c24", fontSize: 18, lineHeight: 32, fontWeight: "900", textAlign: "center", writingDirection: "ltr", includeFontPadding: true },
  gridIntroDescription: { flex: 1, width: "100%", color: "#243727", fontSize: 15, lineHeight: 25, fontWeight: "800", textAlign: "left", includeFontPadding: true },
  sectionLabel: { alignSelf: "center", width: "100%", minHeight: 62, borderRadius: 5, borderWidth: 1, borderColor: "#39a853", backgroundColor: "#bff2c6", alignItems: "flex-start", justifyContent: "center", gap: spacing.sm, paddingHorizontal: spacing.md, paddingVertical: 8 },
  ...
  loShuGrid: { alignSelf: "center", width: 204, height: 156, flexDirection: "row", flexWrap: "wrap", borderRadius: 0, backgroundColor: "#fff", padding: 6, gap: 4, shadowColor: "#0d3440", shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 6 },
  loShuCell: { width: 61.33, height: 45.33, borderRadius: 0, borderWidth: 1, borderColor: "#d9d9d9", backgroundColor: "#f8fff6", alignItems: "center", justifyContent: "center", paddingHorizontal: 5, shadowColor: "#0d3440", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.08, shadowRadius: 2, elevation: 1 },
  loShuCellEmpty: { backgroundColor: "#eeeeee", borderColor: "#d7d7d7" },
  loShuText: { fontSize: 18, fontWeight: "900", color: "#111" },
  loShuTextEmpty: { color: "#9a9a9a" },
  ...
  numberSummaryBox: { borderRadius: 8, backgroundColor: "#fff", overflow: "hidden", shadowColor: "#000", shadowOpacity: 0.22, shadowRadius: 4, shadowOffset: { width: 0, height: 3 }, elevation: 4 },
  numberSummaryRow: { minHeight: 102, flexDirection: "row", backgroundColor: "#fff" },
  numberSummaryRowDivider: { borderTopWidth: 1, borderTopColor: "#d6dfc9" },
  numberSummaryCellWrap: { flex: 1, flexDirection: "row", alignItems: "center" },
  numberSummaryCell: { flex: 1, minHeight: 96, alignItems: "center", justifyContent: "center", paddingHorizontal: 5, paddingVertical: 8 },
  numberSummaryDivider: { width: 1, height: "68%", backgroundColor: "#d6dfc9" },
  ...
  arrowPredictionPanel: { borderRadius: 8, borderWidth: 1.5, borderColor: "#39a853", backgroundColor: "#fffde5", overflow: "hidden", shadowColor: "#0d5a1d", shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.16, shadowRadius: 5, elevation: 4 },
  arrowPredictionTitle: { minHeight: 38, backgroundColor: "#bff2c6", borderBottomWidth: 1, borderBottomColor: "#39a853", color: "#145c24", fontSize: 17, lineHeight: 22, fontWeight: "900", textAlign: "center", textAlignVertical: "center", paddingHorizontal: 8, paddingVertical: 8 },
  arrowPredictionList: { gap: spacing.sm, padding: spacing.sm },
  arrowPredictionCard: { borderWidth: 1, borderColor: "#8dcc83", borderRadius: 6, backgroundColor: "#fff", overflow: "hidden" },
  arrowPredictionStatus: { minHeight: 34, backgroundColor: "#f3ffd7", borderBottomWidth: 1, borderBottomColor: "#d6dfc9", flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: spacing.sm, paddingHorizontal: 8, paddingVertical: 7 },
  arrowPredictionStatusText: { flex: 1, minWidth: 0, color: "#145c24", fontSize: 14, lineHeight: 18, fontWeight: "900", textAlign: "left" },
  arrowPredictionPercentText: { color: "#145c24", fontSize: 14, lineHeight: 18, fontWeight: "900", textAlign: "right" },
  arrowPredictionText: { color: "#111", fontSize: 12, lineHeight: 19, fontWeight: "700", paddingHorizontal: 9, paddingVertical: 8 },
  ...
  relationTable: { width: "100%", backgroundColor: "#cfcfcf", borderWidth: 1.5, borderTopColor: "#f3fff0", borderLeftColor: "#f3fff0", borderRightColor: "#6d806d", borderBottomColor: "#6d806d" },
  ...
  relationNumberHead: { width: "26%", fontSize: 12 },
  relationFriendHead: { width: "24.66%" },
  relationEnemyHead: { width: "24.67%" },
  relationNeutralHead: { width: "24.67%" },
  ...
  relationNumberCell: { width: "9%" },
  relationFriendCell: { width: "24.66%" },
  relationEnemyCell: { width: "24.67%" },
  relationNeutralCell: { width: "24.67%" },
  friendText: { color: "#00a84f" },
  enemyText: { color: "#f00" },
  neutralText: { color: "#858585" },
  relationFoot: { flexDirection: "row", minHeight: 56 },
  relationFootLabel: { width: "26%", fontSize: 10, lineHeight: 15 },
  relationFootValue: { flex: 1, textAlign: "center", textAlignVertical: "center", color: "#111", fontSize: 14, fontWeight: "900", backgroundColor: "#d8d8d8", borderWidth: 1.5, borderTopColor: "#f8f8f8", borderLeftColor: "#f8f8f8", borderRightColor: "#858585", borderBottomColor: "#858585" },
  ...
  yearInputsInHeading: { width: "100%", flexDirection: "row", gap: spacing.sm, alignItems: "center" },
  yearInputInHeading: { flex: 1, minWidth: 0, minHeight: 34, borderWidth: 1, borderColor: "#8dcc83", borderRadius: 5, backgroundColor: "#fffdf5", paddingHorizontal: 8, paddingVertical: 3, color: "#111", fontSize: 12, lineHeight: 16, fontWeight: "800", textAlignVertical: "center", textAlign: "center" },
  smallBtnInHeading: { minWidth: 70, minHeight: 34, paddingHorizontal: spacing.sm, paddingVertical: 3, borderRadius: 5, backgroundColor: "#ffcf28", alignItems: "center", justifyContent: "center", shadowColor: "#7a6100", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.13, shadowRadius: 3, elevation: 2 },
