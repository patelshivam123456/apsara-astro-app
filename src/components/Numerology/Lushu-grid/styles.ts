...
export const styles = StyleSheet.create({
  ...
  gridIntroTitle: { width: "100%", color: "#145c24", fontSize: 18, lineHeight: 32, fontWeight: "900", textAlign: "left", writingDirection: "ltr", includeFontPadding: true },
  ...
  yearInputInHeading: { flex: 1, minWidth: 0, minHeight: 34, borderWidth: 1, borderColor: "#8dcc83", borderRadius: 5, backgroundColor: "#fffdf5", paddingHorizontal: 8, paddingVertical: 3, color: "#111", fontSize: 12, lineHeight: 16, fontWeight: "800", textAlignVertical: "center" },
