...
import { generateMatchMakingPdf } from "@/services/kundali.service";
  ...
  return (
    <SafeAreaView style={styles.root} edges={["top", "left", "right"]}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {!result ? (
          <EmptyState title="No Match Making PDF result" description="Please generate a Match Making PDF first." />
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.body}>{t(astrology?.msg || "PDF match making report successfully generated.")}</Text>
